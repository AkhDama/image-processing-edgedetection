...
public class EdgeDetecSobel {
    public static void main(String args[]) throws IOException {
        ...
        File outputfile = new File("C:\\Users\\Dama Putra\\Pictures\\ImageProcessing\\burungSobel.jpg");
        ImageIO.write(image, "png", outputfile);

        System.out.println("max : " + maxGradient);
        System.out.println("Successfully converted a image into a Sobel Detection Edege");
    }
